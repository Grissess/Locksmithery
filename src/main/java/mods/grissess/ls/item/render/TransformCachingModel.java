...
public class TransformCachingModel implements IModel {
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        Locksmithery.logger.info("TCM.b: baked " + delegate + " to " + baked);
    ...
    public enum Loader implements ICustomModelLoader {
        ...
        public boolean accepts(ResourceLocation modelLocation) {
            boolean result = modelLocation.getResourceDomain().equals(Locksmithery.MODID) &&
                    modelLocation.getResourcePath().startsWith(PREFIX);
            if(result)
                Locksmithery.logger.info("TCM.L.a: overriding models returned for " + modelLocation);
            return result;
        }
        ...
        public IModel loadModel(ResourceLocation modelLocation) throws Exception {
            ...
            Locksmithery.logger.info("TCM.L.lM: mapped " + modelLocation + " to " + rl + " load result " + result);
