package mods.grissess.ls.block.render;
...
public class LiddedSwitchModel extends ModelBase {
    ...
    public static final ResourceLocation TEX_BASE = new ResourceLocation(Locksmithery.MODID, "textures/entity/liddedswitch/base.png");
    public static final ResourceLocation TEX_LID = new ResourceLocation(Locksmithery.MODID, "textures/entity/liddedswitch/lid.png");
    public static final ResourceLocation TEX_SWITCH = new ResourceLocation(Locksmithery.MODID, "textures/entity/liddedswitch/switch.png");
